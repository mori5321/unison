...
import { EditorWsHandler, EditorUpdateHandler, EditorInitHandler, EditorDeleteHandler } from './editor.handler';

const router = Router();
router.get('/sync', SyncHandler);
router.get('/ping', PingHandler);
router.put('/editor', EditorUpdateHandler);
router.delete('/editor', EditorDeleteHandler);
router.post('/editor', EditorInitHandler);
